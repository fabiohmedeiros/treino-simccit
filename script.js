...
Se errar, a questão reaparecerá no final. O treino termina com 100% de acertos.`
            ...
            etapa2: [
                {
                    ...
                    distractor_category: "Empatia (EMP)",
                    options: [
                ...
                },
                {
                    id: "TERAPEUTA_E2_Q2",
                    concept: "FACILITAÇÃO",
                    distractor_category: "Aprovação (APR)",
                    options: [
                ...
                },
                {
                    id: "TERAPEUTA_E2_Q4",
                    concept: "INFORMAÇÃO",
                    distractor_category: "Reprovação (REP)",
                    options: [
                ...
                },
                {
                    ...
                    distractor_category: "Solicitação de Relato (SRE)",
                    options: [
                ...
                },
                {
                    ...
                    distractor_category: "Outras verbalizações do terapeuta (TOU)",
                    options: [
                ...
                },
                {
                    ...
                    distractor_category: "Solicitação de Reflexão (SRF)",
                    options: [
                ...
                },
                {
                    id: "TERAPEUTA_E2_Q9",
                    concept: "REPROVAÇÃO",
                    distractor_category: "Informação (INF)",
                    options: [
    ...
    function showStageInstructions() {
        ...
        const titleEl = document.getElementById('stage-instructions-title');
        
        if (titleEl) {
            titleEl.innerHTML = `Instruções da Etapa ${currentStage}`;
        }
    ...
    async function checkAnswer(selectedOption, button) {
        ...
        // --- MODIFICAÇÃO PARA LOGGING DA ETAPA 2 ---
        let loggedCorrectAnswer = currentAnswer;
        let loggedUserChoice = selectedOption;

        if (currentStage == 2) {
            loggedCorrectAnswer = currentQuestion.concept;
            loggedUserChoice = isCorrect ? currentQuestion.concept : currentQuestion.distractor_category;
        }
        // --- FIM DA MODIFICAÇÃO ---
        ...
        const trialData = {
            ...
            Focus: currentFocus,
            CorrectAnswer: loggedCorrectAnswer,
            UserChoice: loggedUserChoice,
